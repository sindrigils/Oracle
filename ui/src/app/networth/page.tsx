    ...
    <div className="min-h-screen">
      <header className="border-b border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
        <div className="mx-auto flex h-16 max-w-7xl items-center gap-4 px-4 sm:px-6 lg:px-8">
          ...
          <span className="text-xl font-bold text-zinc-900 dark:text-white">Net Worth</span>
        </div>
      </header>

      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-zinc-900 dark:text-white">Net Worth</h1>
          <p className="mt-1 text-zinc-500 dark:text-zinc-400">
            View your overall financial position.
          </p>
        </div>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <p className="max-w-sm text-center text-sm text-zinc-500 dark:text-zinc-400">
              Calculate net worth per member or combined, and track changes over time.
            </p>
          </CardContent>
        </Card>
      </main>
