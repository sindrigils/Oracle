...
Revision ID: 5a9aad0aa4f9
Revises: 
Create Date: 2025-12-30 20:38:35.182117
...
def upgrade() -> None:
    ...
    sa.Column('color', sa.Enum('RED', 'GREEN', 'BLUE', 'YELLOW', 'PURPLE', 'ORANGE', 'PINK', 'BROWN', 'GRAY', 'BLACK', 'WHITE', 'CUSTOM', name='color'), nullable=False),
    ...
    sa.Column('valuation_mode', sa.Enum('MARKET', 'MANUAL', name='valuationmode'), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('short_id', sa.String(), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('transaction_type', sa.Enum('BUY', 'SELL', 'DIVIDEND', 'INTEREST', name='transactiontype'), nullable=False),
    sa.Column('quantity', sa.Integer(), nullable=False),
    sa.Column('date', sa.Date(), nullable=False),
